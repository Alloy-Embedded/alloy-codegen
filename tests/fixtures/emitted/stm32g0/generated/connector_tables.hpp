...
inline constexpr std::array<RouteOperationDescriptor, 12> kRouteOperations = {{
  ...
  {DeviceRefId::stm32g071rb, RouteOperationId::stm32g071rb_operation_reset_release_gpiob, OperationKindId::operation_kind_clear_bit, BackendSchemaId::schema_alloy_clock_st_rcc_g0_v1_0, {RuntimeRefDomain::peripheral, 4u}, {RuntimeRefDomain::reset, 4u}, {RuntimeRefDomain::integer, 0u}, RegisterRefId::stm32g071rb_register_rcc_ioprstr, RegisterFieldRefId::stm32g071rb_field_rcc_ioprstr_gpiobrst, 0},
