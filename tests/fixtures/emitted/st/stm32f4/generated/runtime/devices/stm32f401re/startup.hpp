...
enum class InterruptBindingId : std::uint16_t {
  ...
  interrupt_binding_otg_fs_otg_fs,
...
inline constexpr std::array<VectorSlotDescriptor, 23> kVectorSlots = {{
  ...
  {83, StartupSymbolId::OTG_FS_IRQHandler, InterruptBindingId::interrupt_binding_otg_fs_otg_fs, VectorKindId::vector_kind_external_interrupt},
}};
