...
- [ ] 2.8 Publish SDMMC runtime semantics
- [ ] 2.9 Publish low-power and wakeup runtime semantics

## 3. Configuration UX

- [ ] 3.1 Define declarative generator-side configuration inputs
- [ ] 3.2 Emit explainable configuration diagnostics and alternatives
- [ ] 3.3 Generate board/profile recipes on top of the typed runtime contract
- [ ] 3.4 Generate user-facing example-ready peripheral configuration outputs
