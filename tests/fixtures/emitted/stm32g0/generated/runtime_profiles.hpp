...
inline constexpr std::array<RuntimeProfileDescriptor, 19> kRuntimeProfiles = {{
  ...
  {PeripheralClassId::class_flash, BackendSchemaId::schema_alloy_flash_st_flash, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 2u},
  ...
  {PeripheralClassId::class_gpio, BackendSchemaId::schema_alloy_gpio_st_stm32g07x_gpio_v1_0, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 4u},
  {PeripheralClassId::class_rcc, BackendSchemaId::schema_alloy_rcc_st_rcc_g0_v1_0, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 5u},
  {PeripheralClassId::class_uart, BackendSchemaId::schema_alloy_uart_st_usart_v3_1, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 6u},
  ...
  {PeripheralClassId::none, BackendSchemaId::schema_alloy_clock_st_rcc_g0_v1_0, RuntimeProfileSourceKind::runtime_profile_source_route_operation, 16u},
  ...
  {PeripheralClassId::none, BackendSchemaId::schema_alloy_pinmux_stm32_af_v1, RuntimeProfileSourceKind::runtime_profile_source_route_operation, 18u},
}};
}
}
}
