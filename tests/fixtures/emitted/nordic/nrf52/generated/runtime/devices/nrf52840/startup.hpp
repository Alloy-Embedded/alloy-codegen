...
enum class InterruptBindingId : std::uint16_t {
  ...
  interrupt_binding_rtc0_rtc0_irq,
  interrupt_binding_timer0_timer0_irq,
  interrupt_binding_uart0_uart0_irq,
  interrupt_binding_wdt0_wdt0_irq,
};
...
inline constexpr std::array<VectorSlotDescriptor, 21> kVectorSlots = {{
  ...
  {18, StartupSymbolId::UART0_IRQ_IRQHandler, InterruptBindingId::interrupt_binding_uart0_uart0_irq, VectorKindId::vector_kind_external_interrupt},
  {19, StartupSymbolId::I2C0_IRQ_IRQHandler, InterruptBindingId::interrupt_binding_i2c0_i2c0_irq, VectorKindId::vector_kind_external_interrupt},
  {24, StartupSymbolId::TIMER0_IRQ_IRQHandler, InterruptBindingId::interrupt_binding_timer0_timer0_irq, VectorKindId::vector_kind_external_interrupt},
  {27, StartupSymbolId::RTC0_IRQ_IRQHandler, InterruptBindingId::interrupt_binding_rtc0_rtc0_irq, VectorKindId::vector_kind_external_interrupt},
  {32, StartupSymbolId::WDT0_IRQ_IRQHandler, InterruptBindingId::interrupt_binding_wdt0_wdt0_irq, VectorKindId::vector_kind_external_interrupt},
}};
