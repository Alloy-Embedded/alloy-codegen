...
inline constexpr IpBlockDescriptor kIpBlock = {
  IpBlockId::ip_block_dma_bdma_v1_0,
  PeripheralClassId::class_dma,
  BackendSchemaId::schema_alloy_dma_st_bdma_v1_0,
  RegisterProfileId::register_profile_dma_bdma_v1_0,
  0u,
  0u,
};
