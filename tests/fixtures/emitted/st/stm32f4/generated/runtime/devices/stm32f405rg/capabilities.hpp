...
enum class CapabilityId : std::uint16_t {
  ...
  capability_usart_usart_f4_v1_0_rx,
  capability_usart_usart_f4_v1_0_tx,
  runtime_support_uart,
  runtime_dma_USART1_DMA2_DMA2_STREAM2_RX,
  runtime_dma_USART1_DMA2_DMA2_STREAM7_TX,
...
inline constexpr std::array<CapabilityDescriptor, 22> kCapabilities = {{
  ...
  {CapabilityId::capability_usart_usart_f4_v1_0_rx, CapabilityScopeId::ip_block, PeripheralClassId::class_uart, CapabilityNameId::signal_role, CapabilityValueId::rx, PeripheralId::none},
  {CapabilityId::capability_usart_usart_f4_v1_0_tx, CapabilityScopeId::ip_block, PeripheralClassId::class_uart, CapabilityNameId::signal_role, CapabilityValueId::tx, PeripheralId::none},
  ...
  {CapabilityId::runtime_dma_USART1_DMA2_DMA2_STREAM2_RX, CapabilityScopeId::dma_binding, PeripheralClassId::class_uart, CapabilityNameId::dma_compatible_signal, CapabilityValueId::RX, PeripheralId::USART1},
  {CapabilityId::runtime_dma_USART1_DMA2_DMA2_STREAM7_TX, CapabilityScopeId::dma_binding, PeripheralClassId::class_uart, CapabilityNameId::dma_compatible_signal, CapabilityValueId::TX, PeripheralId::USART1},
...
inline constexpr std::array<CapabilityHardwareLut, 22> kCapabilityHardwareLut = {{
...
template<> struct CapabilityTraits<CapabilityId::runtime_support_dac> : CapabilityTraitsBase<2> {};
template<> struct CapabilityTraits<CapabilityId::device_core_count> : CapabilityTraitsBase<3> {};
template<> struct CapabilityTraits<CapabilityId::device_multicore_topology> : CapabilityTraitsBase<4> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_dma> : CapabilityTraitsBase<5> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_eth> : CapabilityTraitsBase<6> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_gpio> : CapabilityTraitsBase<7> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_rtc> : CapabilityTraitsBase<8> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_spi> : CapabilityTraitsBase<9> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_timer> : CapabilityTraitsBase<10> {};
template<> struct CapabilityTraits<CapabilityId::capability_usart_usart_f4_v1_0_rx> : CapabilityTraitsBase<11> {};
template<> struct CapabilityTraits<CapabilityId::capability_usart_usart_f4_v1_0_tx> : CapabilityTraitsBase<12> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_uart> : CapabilityTraitsBase<13> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_USART1_DMA2_DMA2_STREAM2_RX> : CapabilityTraitsBase<14> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_USART1_DMA2_DMA2_STREAM7_TX> : CapabilityTraitsBase<15> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart1_lqfp64_rx> : CapabilityTraitsBase<16> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart1_lqfp64_tx> : CapabilityTraitsBase<17> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart2_lqfp64_rx> : CapabilityTraitsBase<18> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart2_lqfp64_tx> : CapabilityTraitsBase<19> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_usb> : CapabilityTraitsBase<20> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_watchdog> : CapabilityTraitsBase<21> {};
...
struct PeripheralClassCapabilityTraits<PeripheralClassId::class_uart> {
  ...
  inline static constexpr std::array<CapabilityId, 9> kCapabilityIds = {{
    CapabilityId::capability_usart_usart_f4_v1_0_rx,
    CapabilityId::capability_usart_usart_f4_v1_0_tx,
    CapabilityId::runtime_support_uart,
    CapabilityId::runtime_dma_USART1_DMA2_DMA2_STREAM2_RX,
    CapabilityId::runtime_dma_USART1_DMA2_DMA2_STREAM7_TX,
...
template<>
struct PeripheralCapabilityTraits<PeripheralId::Ethernet_MAC> {
  static constexpr bool kPresent = false;
  inline static constexpr std::array<CapabilityId, 0> kCapabilityIds = {{
  }};
};
...
template<>
struct PeripheralCapabilityTraits<PeripheralId::OTG_FS> {
  static constexpr bool kPresent = false;
  inline static constexpr std::array<CapabilityId, 0> kCapabilityIds = {{
  }};
};
