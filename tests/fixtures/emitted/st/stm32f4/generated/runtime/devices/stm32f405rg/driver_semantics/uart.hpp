...
struct UartSemanticTraits<PeripheralId::USART1> {
  ...
  static constexpr std::array<DmaBindingRef, 2> kDmaBindings = {{
    DmaBindingRef{DmaControllerId::DMA2, DmaBindingId::dma_binding_usart1_rx_dma2_dma2_stream2, 0u, DmaBindingDirection::Rx, 8u, true},
    DmaBindingRef{DmaControllerId::DMA2, DmaBindingId::dma_binding_usart1_tx_dma2_dma2_stream7, 0u, DmaBindingDirection::Tx, 8u, true},
  }};
