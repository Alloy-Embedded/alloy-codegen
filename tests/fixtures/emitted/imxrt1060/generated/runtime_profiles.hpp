...
inline constexpr std::array<RuntimeProfileDescriptor, 23> kRuntimeProfiles = {{
  ...
  {PeripheralClassId::class_gpio, BackendSchemaId::schema_alloy_gpio_nxp_imxrt_gpio_v1, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 2u},
  {PeripheralClassId::class_lpi2c1, BackendSchemaId::schema_alloy_lpi2c1_nxp_lpi2c_v1, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 3u},
  {PeripheralClassId::class_spi, BackendSchemaId::schema_alloy_spi_nxp_lpspi_v1, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 4u},
  ...
  {PeripheralClassId::class_uart, BackendSchemaId::schema_alloy_uart_nxp_lpuart_v1, RuntimeProfileSourceKind::runtime_profile_source_peripheral, 6u},
  {PeripheralClassId::none, BackendSchemaId::schema_alloy_clock_nxp_ccm, RuntimeProfileSourceKind::runtime_profile_source_route_operation, 7u},
  {PeripheralClassId::none, BackendSchemaId::schema_alloy_clock_nxp_ccm, RuntimeProfileSourceKind::runtime_profile_source_route_operation, 8u},
