...
def emit_rcc_enable(
    ...
    lines += [
        ...
        "template <typename P> void clk_enable()    = delete;  // NOLINT",
        "template <typename P> void clk_disable()   = delete;  // NOLINT",
        "template <typename P> void rst_assert()    = delete;  // NOLINT",
        "template <typename P> void rst_release()   = delete;  // NOLINT",
        "template <typename P> void peripheral_on() = delete;  // NOLINT",
        "",
        "// ============================================================================",
