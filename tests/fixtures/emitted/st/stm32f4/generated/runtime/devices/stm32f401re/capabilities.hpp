...
inline constexpr std::array<CapabilityHardwareLut, 19> kCapabilityHardwareLut = {{
...
template<> struct CapabilityTraits<CapabilityId::runtime_support_gpio> : CapabilityTraitsBase<4> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_rtc> : CapabilityTraitsBase<5> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_spi> : CapabilityTraitsBase<6> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_timer> : CapabilityTraitsBase<7> {};
template<> struct CapabilityTraits<CapabilityId::capability_usart_usart_f4_v1_0_rx> : CapabilityTraitsBase<8> {};
template<> struct CapabilityTraits<CapabilityId::capability_usart_usart_f4_v1_0_tx> : CapabilityTraitsBase<9> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_uart> : CapabilityTraitsBase<10> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart1_lqfp64_rx> : CapabilityTraitsBase<11> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart1_lqfp64_tx> : CapabilityTraitsBase<12> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_USART2_DMA1_DMA1_STREAM5_RX> : CapabilityTraitsBase<13> {};
template<> struct CapabilityTraits<CapabilityId::runtime_dma_USART2_DMA1_DMA1_STREAM6_TX> : CapabilityTraitsBase<14> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart2_lqfp64_rx> : CapabilityTraitsBase<15> {};
template<> struct CapabilityTraits<CapabilityId::capability_instance_usart2_lqfp64_tx> : CapabilityTraitsBase<16> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_usb> : CapabilityTraitsBase<17> {};
template<> struct CapabilityTraits<CapabilityId::runtime_support_watchdog> : CapabilityTraitsBase<18> {};
