...
template<>
struct InterruptSlotValid<PeripheralId::DMA1, 32u> : std::true_type {
  static constexpr std::uint16_t kIrqLine = 16u;
};

template<>
struct InterruptSlotValid<PeripheralId::DMA1, 33u> : std::true_type {
...
inline constexpr std::array<InterruptSlotEntry, 7> kInterruptSlots = {{
  {PeripheralId::DMA1, 27u, 11u},
  {PeripheralId::DMA1, 32u, 16u},
  {PeripheralId::DMA1, 33u, 17u},
