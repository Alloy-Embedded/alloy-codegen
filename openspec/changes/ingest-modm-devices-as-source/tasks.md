...
- [ ] 1.1 Create `src/alloy_codegen/sources/modm_devices.py`.
- [ ] 1.2 Parse `modm-devices/devices/stm32/<family>/<part>.xml`
      using `lxml`.
- [ ] 1.3 Map modm's XML schema into our intermediate objects
