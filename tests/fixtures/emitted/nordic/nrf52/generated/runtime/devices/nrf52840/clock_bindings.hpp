...
template<>
struct PeripheralClockBindingTraits<PeripheralId::GPIO0> {
...
template<>
struct PeripheralClockBindingTraits<PeripheralId::RTC0> {
  static constexpr bool kPresent = true;
  static constexpr ClockGateId kClockGateId = ClockGateId::none;
  static constexpr ResetId kResetId = ResetId::none;
  static constexpr ClockSelectorId kSelectorId = ClockSelectorId::none;
...
template<>
struct PeripheralClockBindingTraits<PeripheralId::TIMER0> {
  static constexpr bool kPresent = true;
  static constexpr ClockGateId kClockGateId = ClockGateId::none;
  static constexpr ResetId kResetId = ResetId::none;
  static constexpr ClockSelectorId kSelectorId = ClockSelectorId::none;
...
template<>
struct PeripheralClockBindingTraits<PeripheralId::WDT0> {
  static constexpr bool kPresent = true;
  static constexpr ClockGateId kClockGateId = ClockGateId::none;
  static constexpr ResetId kResetId = ResetId::none;
  static constexpr ClockSelectorId kSelectorId = ClockSelectorId::none;
...
inline constexpr std::array<PeripheralId, 7> kClockBoundPeripherals = {{
  PeripheralId::GPIO0,
  PeripheralId::I2C0,
  PeripheralId::RTC0,
  PeripheralId::SPI0,
