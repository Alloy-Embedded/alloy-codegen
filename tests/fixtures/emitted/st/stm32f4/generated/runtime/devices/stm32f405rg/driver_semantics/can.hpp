...
struct CanSemanticTraits<PeripheralId::CAN1> {
  ...
  static constexpr BackendSchemaId kSchemaId = BackendSchemaId::schema_alloy_can_st_can;
  static constexpr bool kHasFlexibleDataRate = false;
  ...
  static constexpr RuntimeRegisterRef kDataTimingRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kTestRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 28u, true};
  static constexpr RuntimeRegisterRef kErrorCounterRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 24u, true};
  static constexpr RuntimeRegisterRef kProtocolStatusRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 4u, true};
  static constexpr RuntimeRegisterRef kInterruptRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 4u, true};
  static constexpr RuntimeRegisterRef kInterruptEnableRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 20u, true};
  static constexpr RuntimeRegisterRef kInterruptLineSelectRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kInterruptLineEnableRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kGlobalFilterRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 512u, true};
  static constexpr RuntimeRegisterRef kStandardFilterConfigRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 516u, true};
  static constexpr RuntimeRegisterRef kExtendedFilterConfigRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 524u, true};
  static constexpr RuntimeRegisterRef kExtendedIdMaskRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kRxFifo0ConfigRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 12u, true};
  static constexpr RuntimeRegisterRef kRxFifo0StatusRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 12u, true};
  static constexpr RuntimeRegisterRef kRxFifo0AckRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 12u, true};
  static constexpr RuntimeRegisterRef kTxBufferConfigRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 8u, true};
  static constexpr RuntimeRegisterRef kTxFifoQueueStatusRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 8u, true};
  static constexpr RuntimeRegisterRef kTxBufferAddRequestRegister = RuntimeRegisterRef{RegisterId::none, 0x40006400u, 384u, true};
  static constexpr RuntimeRegisterRef kTxBufferPendingRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kTxEventFifoConfigRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kTxEventFifoStatusRegister = kInvalidRegisterRef;
  static constexpr RuntimeRegisterRef kTxEventFifoAckRegister = kInvalidRegisterRef;
