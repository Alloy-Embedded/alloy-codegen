...
- [ ] 3.1 Extend `runtime_interrupts.py` (or add a sibling
...
- [ ] 4.2 `i2c_speed_validation.hpp` defines a `consteval`
...
- [ ] 6.2 `openspec validate add-additional-validity-concepts
      --strict` passes.
