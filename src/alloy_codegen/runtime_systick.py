"""Generated runtime-lite SysTick helpers."""
...
from .emission import _cpp_artifact, _cpp_namespace_block, _enum_rows
from .runtime_lite_emission import (
    _device_runtime_generated_path,
    _runtime_device_namespace_components,
)

SYSTICK_HEADER = "systick.hpp"


def _is_cortex_m_device(device: CanonicalDeviceIR) -> bool:
    return device.identity.core.lower().startswith("cortex-m")


def runtime_systick_required_paths(
    *,
    family_dir: str,
    devices: tuple[CanonicalDeviceIR, ...],
) -> tuple[str, ...]:
    return tuple(
        _device_runtime_generated_path(family_dir, device.identity.device, SYSTICK_HEADER)
        for device in devices
        if _is_cortex_m_device(device)
    )


def emit_runtime_systick_header(
    *,
    family_dir: str,
    device: CanonicalDeviceIR,
) -> EmittedArtifact:
    present = _is_cortex_m_device(device)
    namespace_components = _runtime_device_namespace_components(device)
    body = "\n".join(
        [
            ...
            *_enum_rows(
                {
                    ...
                    "alternate_reference_clock": "alternate_reference_clock",
                },
            ...
            f"  static constexpr bool kPresent = {'true' if present else 'false'};",
            ...
            "  static constexpr SysTickClockSourceId kDefaultClockSource = "
            "SysTickClockSourceId::processor_clock;",
            "  static constexpr RuntimeRegisterRef kCtrlRegister = "
            "RuntimeRegisterRef{RegisterId::none, 0xE000E010u, 0u, kPresent};",
            "  static constexpr RuntimeRegisterRef kLoadRegister = "
            "RuntimeRegisterRef{RegisterId::none, 0xE000E010u, 4u, kPresent};",
            "  static constexpr RuntimeRegisterRef kValRegister = "
            "RuntimeRegisterRef{RegisterId::none, 0xE000E010u, 8u, kPresent};",
            "  static constexpr RuntimeRegisterRef kCalibRegister = "
            "RuntimeRegisterRef{RegisterId::none, 0xE000E010u, 12u, kPresent};",
            "  static constexpr RuntimeFieldRef kEnableField = "
            "RuntimeFieldRef{FieldId::none, kCtrlRegister, 0u, 1u, kPresent};",
            "  static constexpr RuntimeFieldRef kTickIntField = "
            "RuntimeFieldRef{FieldId::none, kCtrlRegister, 1u, 1u, kPresent};",
            "  static constexpr RuntimeFieldRef kClkSourceField = "
            "RuntimeFieldRef{FieldId::none, kCtrlRegister, 2u, 1u, kPresent};",
            "  static constexpr RuntimeFieldRef kCountFlagField = "
            "RuntimeFieldRef{FieldId::none, kCtrlRegister, 16u, 1u, kPresent};",
            "  static constexpr RuntimeFieldRef kReloadField = "
            "RuntimeFieldRef{FieldId::none, kLoadRegister, 0u, 24u, kPresent};",
            "  static constexpr RuntimeFieldRef kCurrentField = "
            "RuntimeFieldRef{FieldId::none, kValRegister, 0u, 24u, kPresent};",
            "  static constexpr RuntimeFieldRef kTenMsField = "
            "RuntimeFieldRef{FieldId::none, kCalibRegister, 0u, 24u, kPresent};",
            "  static constexpr RuntimeFieldRef kSkewField = "
            "RuntimeFieldRef{FieldId::none, kCalibRegister, 30u, 1u, kPresent};",
            "  static constexpr RuntimeFieldRef kNoRefField = "
            "RuntimeFieldRef{FieldId::none, kCalibRegister, 31u, 1u, kPresent};",
            "};",
            "",
            ...
            "  return ((field.bit_width >= 32u ? 0xFFFF'FFFFu : ((1u << field.bit_width) - 1u)) "
            "<< field.bit_offset);",
            "}",
            "",
            ...
            "    SysTickClockSourceId source = SysTickTraits::kDefaultClockSource,",
            "    bool interrupt_enable = true) {",
            "  if (!SysTickTraits::kPresent || source == SysTickClockSourceId::none "
            "|| source_clock_hz == 0u || tick_hz == 0u) {",
            "    return false;",
            "  }",
    ...
    namespace_block = _cpp_namespace_block(namespace_components, body)
    content = "\n".join(
        [
            "#pragma once",
            "",
    ...
    return _cpp_artifact(
        path=_device_runtime_generated_path(family_dir, device.identity.device, SYSTICK_HEADER),
        content=content,
    )
