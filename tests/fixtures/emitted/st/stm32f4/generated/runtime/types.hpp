...
enum class BackendSchemaId : std::uint16_t {
  ...
  schema_alloy_clock_st_rcc_f4_v1_0,
  schema_alloy_dma_st_bdma_f4_v1_0,
  schema_alloy_flash_st_flash,
  schema_alloy_gpio_st_stm32f4x_gpio_v1_0,
  schema_alloy_pinmux_stm32_af_v1,
  schema_alloy_rcc_st_rcc_f4_v1_0,
  schema_alloy_rtc_st_rtc,
  schema_alloy_spi_st_spi,
  schema_alloy_timer_st_tim,
  schema_alloy_uart_st_usart_f4_v1_0,
  schema_alloy_usb_st_otg_fs,
