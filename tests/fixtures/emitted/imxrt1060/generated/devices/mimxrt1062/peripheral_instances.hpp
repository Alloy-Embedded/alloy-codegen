...
inline constexpr std::array<PeripheralInstanceDescriptor, 9> kPeripheralInstances = {{
  {PeripheralId::CCM, PeripheralClassId::class_ccm, BackendSchemaId::schema_alloy_ccm_nxp_ccm, 0, 0x400FC000u, ClockGateId::none, ResetId::none, ClockSelectorId::none, 0u, 0u, 0u, 0u, 0u, 0u, 13},
  {PeripheralId::CCM_ANALOG, PeripheralClassId::class_ccm_analog, BackendSchemaId::schema_alloy_ccm_analog_nxp_ccm_analog, 0, 0x400D8000u, ClockGateId::none, ResetId::none, ClockSelectorId::none, 0u, 0u, 0u, 0u, 0u, 0u, 1},
  {PeripheralId::DCDC, PeripheralClassId::class_dcdc, BackendSchemaId::schema_alloy_dcdc_nxp_dcdc, 0, 0x40080000u, ClockGateId::none, ResetId::none, ClockSelectorId::none, 0u, 0u, 0u, 0u, 0u, 0u, 2},
